...
#include "offboard_pkg/PositionReference.h"
#include "offboard_pkg/Message.h"
#include "offboard_pkg/DroneState.h"
...
private:
    ...
    offboard_pkg::DroneState _DroneState;
    nav_msgs::Odometry Drone_odom;

    nav_msgs::Path path_cmd;
    nav_msgs::Path path_cmd_last;

    double distance_walked;
    offboard_pkg::ControlCommand Command_Now;   
    ...
    int start_point_index_last;
    int Num_total_wp;
    int Num_total_wp_last;
    int cur_id;
    int cur_id_last;
    ...
    void drone_state_cb(const offboard_pkg::DroneStateConstPtr &msg);

    void local_pos_cb(const geometry_msgs::PoseStampedConstPtr& msg);
    void local_velocity_cb(const geometry_msgs::TwistStampedConstPtr& msg);
    void mavros_state_cb(const mavros_msgs::StateConstPtr& msg);
    ...
    int get_start_point_id_last(void);
